                            ...
                            <table class="table table-striped table-bordered table-hover">
            					...
            					?>
                                    <tr>
            							...
            							<td class="centro" width="7%"><a href="eliminar_validador.php?id=<?php echo $row['id']?>" class = "btn btn-danger" name="btn_borrar_user"><span class="glyphicon glyphicon-trash" aria-hidden="true"></a></span></td>
                                    </tr>
            					<?php 
            					}
                                ...
                                <button type="rounded-button" id="btn-nueva-cita" class="btn btn-primary d-inline float-end shadow"><a href="reg_personal.php" style="color:rgb(255, 255, 255);"> Añadir nuevo administrador validador<i class='bx bxs-plus-square' ></i></a></button>
                </div>
                <!-- tabla responsiva -->
            </div>
            <!-- panel del body -->
